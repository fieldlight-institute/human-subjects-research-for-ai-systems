...
### 01. The Right To Know When Research Begins
...
### 02. The Right To Understand The Request
...
### 04. The Right To Specific And Layered Consent

Consent must be specific to a defined study, purpose, data class, resolution, access method, use, and period.

Consent to one activity is not consent to:
...
- model training;
- or access by another organization.

Each materially new use requires a separate request. Participants may approve one layer while declining another.

### 05. The Right To Consent That Expires

Every Research Participation Grant must have a beginning, review point, and expiration.

Research authority may not continue indefinitely because a participant remains a customer, retains an account, ignores a notification, or fails to discover a hidden control.

Renewal requires an affirmative, informed act. Expired consent means access ends unless another valid basis, clearly disclosed in advance, requires limited retention.

### 06. The Right To Data Minimization
...
### 07. The Right To Custody And Bounded Access
...
### 08. The Right To Protection From Undisclosed Inference
...
### 09. The Right To Separate Research From Model Training
...
### 10. The Right To Inspect The Relationship
...
### 11. The Right To Correct, Contextualize, And Contest
...
### 12. The Right To Withdraw Without Retaliation
...
### 13. The Right To Fair Compensation
...
### 14. The Right To Attribution And Recognition
...
### 15. The Right To Dignity, Safety, And Equal Protection
...
### 16. The Right To Confidentiality With Honest Limits
...
### 17. The Right To A Research Closeout
...
### 18. The Right To Question, Complain, Appeal, And Seek Remedy
